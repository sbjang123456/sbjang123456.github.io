...
│   │   ├── alrim-talk-list
│   │   ├── as-proc-gubn
│   │   ├── as-proc-gubn-mapping
│   │   ├── as-request-confirm-check
│   │   ├── as-request-confirm-print
...
│   │   ├── pm-prdgrp-mapping
│   │   ├── pm-proc-mapping
│   │   ├── post-judgement-output
│   │   ├── post-judgement-output-new
│   │   ├── process-code
│   │   ├── processing-result
│   │   ├── processing-result-hanssem
│   │   ├── progress-search
│   │   ├── progress-status
│   │   ├── quality-data
│   │   ├── quality-hierarchy
│   │   ├── re-receipt
│   │   ├── receipt-money-manage
│   │   ├── receipt-total
│   │   ├── reception
│   │   ├── region-link
│   │   ├── relation
...
│   │   ├── sms-count
│   │   ├── sofa-additional-fee
│   │   ├── sofa-direct-delivery-cost
│   │   ├── srp-order
│   │   ├── stock-center-process
│   │   ├── stock-engi-process
│   │   ├── stock-engi-result
│   │   ├── stock-master
│   │   ├── stock-usage-list
│   │   ├── technical-fee
│   │   ├── three-more-receipt-list
│   │   ├── total-situation
│   │   ├── transfer-list
│   │   ├── transfer-search
│   │   ├── unvisit-order-rate
...
│       ├── capa-adjust
│       ├── consumer-request
│       ├── customer-additional-info-dialog
│       ├── evaluation-analysis
│       ├── layout
│       ├── master-management
│       ├── one-order-search-dialog
│       ├── order-stock-request-dialog
│       ├── paid-collection
│       ├── part-team-link
│       ├── payment-management
│       ├── process-code
